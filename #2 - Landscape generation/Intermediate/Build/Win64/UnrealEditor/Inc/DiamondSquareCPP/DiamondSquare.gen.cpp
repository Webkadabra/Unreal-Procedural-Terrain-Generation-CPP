...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ZMin_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ZMin;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ZMax_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ZMax;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMin_MetaData[] = {
		{ "Category", "DiamondSquare" },
		{ "ModuleRelativePath", "Public/DiamondSquare.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMin = { "ZMin", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADiamondSquare, ZMin), METADATA_PARAMS(Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMin_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMax_MetaData[] = {
		{ "Category", "DiamondSquare" },
		{ "ModuleRelativePath", "Public/DiamondSquare.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMax = { "ZMax", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADiamondSquare, ZMax), METADATA_PARAMS(Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMax_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMax_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ADiamondSquare_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMin,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ADiamondSquare_Statics::NewProp_ZMax,
	...
	struct Z_CompiledInDeferFile_FID__3___Flat_terrain_Source_DiamondSquareCPP_Public_DiamondSquare_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID__3___Flat_terrain_Source_DiamondSquareCPP_Public_DiamondSquare_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ADiamondSquare, ADiamondSquare::StaticClass, TEXT("ADiamondSquare"), &Z_Registration_Info_UClass_ADiamondSquare, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADiamondSquare), 684776301U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID__3___Flat_terrain_Source_DiamondSquareCPP_Public_DiamondSquare_h_2936130924(TEXT("/Script/DiamondSquareCPP"),
		Z_CompiledInDeferFile_FID__3___Flat_terrain_Source_DiamondSquareCPP_Public_DiamondSquare_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID__3___Flat_terrain_Source_DiamondSquareCPP_Public_DiamondSquare_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
